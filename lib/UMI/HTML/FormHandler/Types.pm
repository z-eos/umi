...
use MooseX::Types -declare => [
    'PositiveNum',    'PositiveInt', 'NegativeNum',         'NegativeInt', 'CIDR',
...
Must be a valid IPv4 CIDR (IP address with bit mask like 1.2.3.4/24).
