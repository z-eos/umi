...
sub index :Path :Args(0) {
    ...
    if ( exists $key->{error} ) {
      ...
      $key->{html}->{success} =
      sprintf('<div class="panel panel-default">
  <div class="panel-heading"><h3 class="panel-title"><b>PRIVATE</b></h3></div>
  <div class="panel-body"><pre>%s</pre></div>
</div>
<div class="panel panel-default">
  <div class="panel-heading"><h3 class="panel-title"><b>PUBLIC</b></h3></div>
  <div class="panel-body"><p class="mono">%s generated by %s on %s via UMI</p></div>
</div>',
	      $key->{private},
	      $key->{public},
	      $c->user,
