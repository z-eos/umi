...
pwd_alg - algo name as it is in password generation form
...
xk
    ...
    Password generated (with Crypt::HSXKPasswd)
...
sub pwdgen {
  ...
  if (! defined $p->{pwd} || $p->{pwd} eq '') {
    ### a new password generation (not verification)
